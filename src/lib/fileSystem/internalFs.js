        ...
        return new Promise((resolve, reject) => {
            this.verify(src, dest)
                .then(res => {
                    ...
                    src[action](dest, undefined, entry => resolve(decodeURL(entry.nativeURL)), reject);
                })
                .catch(reject);
        });
    },
        ...
        return new Promise((resolve, reject) => {
            window.resolveLocalFileSystemURL(src, srcEntry => {
                window.resolveLocalFileSystemURL(dest, destEntry => {
                    window.resolveLocalFileSystemURL(decodeURL(destEntry.nativeURL) + srcEntry.name, res => {
