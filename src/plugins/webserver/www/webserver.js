...
module.exports = {
  start: function (success_callback, error_callback, port) {
    ...
    cordova.exec(success_callback, error_callback, WEBSERVER_CLASS, START_FUNCTION, params);
  },
  ...
  sendResponse: function (requestId, params, success_callback, error_callback) {
    cordova.exec(success_callback, error_callback, WEBSERVER_CLASS, SENDRESPONSE_FUNCION, [requestId, params]);
  },
  stop: function (success_callback, error_callback) {
    cordova.exec(success_callback, error_callback, WEBSERVER_CLASS, STOP_FUNCTION, []);
  }
};