...
public class Webserver extends CordovaPlugin {
    ...
    private void start(JSONArray args, CallbackContext callbackContext) throws JSONException, IOException {
        ...
        try {
            this.nanoHTTPDWebserver = new NanoHTTPDWebserver(port, this, cordova.getContext());
        ...
        Log.d(this.getClass().getName(), "Server is running on: " + this.nanoHTTPDWebserver.getHostname() + ":"
