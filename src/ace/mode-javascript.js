    ...
    var keywordMapper = this.createKeywordMapper(
      {
        'variable.language':
          ...
          'console|decodeURI|decodeURIComponent|encodeURI|encodeURIComponent|eval|isFinite|' + // Non-constructor functions
    ...
    this.$rules = {
      no_regex: [
        ...
        },
        {
          ...
          regex:
            /(console)(\.)(assert|clear|count|countReset|debug|dir|dirxml|error|group|groupCollapsed|groupEnd|info|log|table|time|timeEnd|timeLog|trace|warn)\b/,
        },
        {
          token: keywordMapper,
          regex: identifierRe,
